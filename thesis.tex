...
\begin{figure*}[h]
\centering
\subfigure[Ambiguous gesture.\label{fig:confused_pic}]{\includegraphics[width=0.49\linewidth]{images/ambiguous_pic.png}}
\subfigure[Clarification with language.\label{fig:clarified_pic}]{\includegraphics[width=0.49\linewidth]{images/clarification_pic.png}}
\subfigure[State estimate during ambiguous speech.\label{fig:confused_dist}]{\includegraphics[width=0.49\linewidth]{images/ambiguous_dist.png}}
\subfigure[State estimate after clarification.\label{fig:clarified_dist}]{\includegraphics[width=0.49\linewidth]{images/clarification_dist.png}}
...
\begin{figure}[h]
\centering
\fbox{\includegraphics[scale=0.5]{images/labeled_obs2.png}}
